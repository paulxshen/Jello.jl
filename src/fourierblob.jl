...
"""
    FourierBlob(sz...; nbasis=4, contrast=1, T=Float32, rmin=nothing, rvalssolid=rmin, rvalsvoid=rmin, symdims=[], diagonal_symmetry=false)
    (m::FourierBlob)()
...
function (m::FourierBlob)()
    @unpack p, sz, asz, mask, symdims, = m
